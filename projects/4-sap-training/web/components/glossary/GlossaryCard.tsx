  ...
  return (
    <div className="rounded-lg border border-line bg-white p-4">
      <div className="flex items-start justify-between gap-2">
        <h3 lang="ja" className="text-lg font-semibold text-ink">{term.japanese}</h3>
      ...
      <p className="mt-2 text-sm text-slate-600">示例句：<span lang="ja">{term.exampleSentence}</span></p>
