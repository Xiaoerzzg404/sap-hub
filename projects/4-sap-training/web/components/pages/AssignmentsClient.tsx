...
export function AssignmentsClient({ lessons, allAssignments }: { lessons: Lesson[]; allAssignments: Assignment[] }) {
  const [lessonId, setLessonId] = useState("");
  const assignments = useMemo(() => allAssignments.filter((item) => !lessonId || item.lessonId === lessonId), [allAssignments, lessonId]);
