...
## 任务前必读规则
任何 AI 工具、任何身份，只要处理本 Project 的日语内容、课程设计、SAP 项目语言表达、
网站结构、网站功能、录音/反馈/数据/权限/运营，都必须先读：

`projects/4-sap-training/AGENT_GUARDRAILS.md`

该文件的保护用户、保护数据、保护历史履历、保护功能、验证和停手机制优先于一般优化冲动。
