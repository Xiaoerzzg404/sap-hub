# handoff_lesson_07_v4_teacher_focused
...
- `handoff_lesson_07_v4_teacher_focused.md`

## 2. 讲师明天如何上课

上课打开学生 PPT、逐页逐字稿、课堂练习包。课堂始终围绕：面试或项目初期，顾问需要用简洁日语说明日本企业IT转型的大方向和SAP顾问应关注的点。

## 3. 逐字稿增强点

- 28 页逐页对应学生 PPT。
- 每页包含中文口播、日语示范、领读、练习、可能回答、点评、错误、过渡、必背句、时间建议。

## 4. 集中情况

课堂练习、学生资料、case-pack、表达资产均已集中到各自单一文件。

## 5. 仍需人工确认事项

1. 逐字稿口吻是否符合用户实际授课风格。
2. 本课主案例是否需要换成用户真实项目案例。
3. 日语表达是否需要母语者最终润色。
