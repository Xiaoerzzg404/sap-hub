...
本课主题：日本企业整体信息化架构。不要讲成普通日语课，也不要讲成 SAP 配置课。课堂主线必须始终围绕：
...
- Roleplay 允许看稿。
- 模块替换只做学生自己模块。
- 录音作业允许 40 秒，但必须包含本课五步结构。
- 讲师纠错只抓 3 个：结构缺失、对象不清、语气不自然。

## 9. 学生都是高级顾问时如何加深

- 要求学生脱稿完成 60 秒表达。
- Roleplay 中追加客户追问，让学生守住边界。
- 要求加入自己模块的对象、风险、下一步和跨团队协作。
- 录音作业必须包含项目对象和后续行动。

## 10. 讲师当天授课心法

这节课的核心不是让学生“知道更多日语”，而是让他们在日本 SAP 项目现场能自然开口。请讲师不断把学生拉回四个问题：

1. 这个表达在什么项目场景使用？
2. 这句话解决什么项目功能？
3. 换到学生自己的模块后，具体对象是什么？
4. 听完后，对方是否知道下一步？
