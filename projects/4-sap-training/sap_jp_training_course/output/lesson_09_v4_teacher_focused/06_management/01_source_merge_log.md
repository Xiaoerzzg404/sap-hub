...
| `prompts_v4/single_lessons/lesson_09_v4_codex_prompt.md` | 采用 Lesson09 标题、主场景、核心句型、词汇、课堂互动和课后作业 |

## 2. 内容吸收记录

| Prompt 要求 | 本包落点 |
|---|---|
| 本课主题：日本企业信息安全制度 | 学生 PPT S01-S10、逐字稿 S01-S10 |
| 主场景：顾问想下载生产数据做调查，但客户安全规则不允许。需要申请脱敏数据或在受控环境中分析。 | S06、S20、练习包 Ex1/Ex8、录音作业 |
