...
| `prompts_v4/single_lessons/lesson_08_v4_codex_prompt.md` | 采用 Lesson08 标题、主场景、核心句型、词汇、课堂互动和课后作业 |

## 2. 内容吸收记录

| Prompt 要求 | 本包落点 |
|---|---|
| 本课主题：日本企业数据管理标准 | 学生 PPT S01-S10、逐字稿 S01-S10 |
| 主场景：上线前主数据准备不完整，导致测试无法推进。顾问需要向业务说明影响和补充要求。 | S06、S20、练习包 Ex1/Ex8、录音作业 |
