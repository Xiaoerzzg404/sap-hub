...
| `prompts_v4/single_lessons/lesson_10_v4_codex_prompt.md` | 采用 Lesson10 标题、主场景、核心句型、词汇、课堂互动和课后作业 |

## 2. 内容吸收记录

| Prompt 要求 | 本包落点 |
|---|---|
| 本课主题：日本SAP市场规模与主要客户群体 | 学生 PPT S01-S10、逐字稿 S01-S10 |
| 主场景：面向准备赴日的SAP顾问，说明日本市场常见客户类型与顾问需要关注的业务重点。 | S06、S20、练习包 Ex1/Ex8、录音作业 |
